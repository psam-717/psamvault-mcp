...
`psamvault-mcp compat --apply` (a release marked `breaking` needs `--allow-breaking`; `--from-git` installs
...
- [ ] Host reloaded after config change; doctor/handshake OK (13 tools in v0.5.0+)
